...
/**
 * Processes uploaded ZIP files and stores them as versioned packages.
 */
class UploadHandler {

	/**
	 * Absolute path to the directory where packages are stored.
	 *
	 * @var string
	 */
	...
	/**
	 * Cache backend for invalidating metadata after upload.
	 *
	 * @var ?CacheInterface
	 */
