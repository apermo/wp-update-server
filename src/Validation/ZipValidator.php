...
/**
 * Validates that a ZIP archive conforms to WordPress plugin/theme packaging standards.
 */
class ZipValidator {

	/**
	 * Validate a ZIP archive against WordPress packaging conventions.
	 *
	 * @param string      $zipPath         Path to the ZIP file.
	 * @param string|null $expectedSlug    Slug the top-level directory must match.
	 * @param string|null $expectedVersion Version the header must contain.
	 */
